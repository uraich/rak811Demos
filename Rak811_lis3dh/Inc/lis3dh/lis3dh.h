...
#define LIS3DH_TEMPERATURE_OFFSET                         15
/* Exported macro ------------------------------------------------------------*/
...
void printAccValue(int16_t accX,int16_t accY,int16_t accZ,int compose);

void printAccRaw(int16_t accX,int16_t accY,int16_t accZ);
