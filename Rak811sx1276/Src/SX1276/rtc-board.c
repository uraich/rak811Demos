...
void printCalendar (RtcCalendar_t cal) {
  printf("Calendar values:\n");
  printf("Date: %d.%d.%d\n",cal.CalendarDate.Date,cal.CalendarDate.Month,cal.CalendarDate.Year);
  printf("Time: %d:%d:%d\n",cal.CalendarTime.Hours,cal.CalendarTime.Minutes,cal.CalendarTime.Seconds);
}
...
static TimerTime_t RtcConvertCalendarTickToTimerTime( RtcCalendar_t *calendar )
{
    ...
    if( calendar == NULL )
    {
      //        printf("RtcConvertCalendarTickToTimerTime: getting calendar for now\n");
        now = RtcGetCalendar( );
    }
    else
    {
      //        printf("RtcConvertCalendarTickToTimerTime: getting calendar for specified time and date\n");
        now = *calendar;
    }
    //    printCalendar(now);
    //    now.CalendarDate.Year = 2018;
    //    now.CalendarDate.Month = 7;
    ...
    //    printf("RtcConvertCalendarTickToTimerTime: after years calculation: timeCounterTemp: %10.4lf\n",timeCounterTemp);
    ...
    //    printf("RtcConvertCalendarTickToTimerTime: after months calculation: timeCounterTemp: %10.4lf\n",timeCounterTemp);
    ...
    //    printf("RtcConvertCalendarTickToTimerTime: returning timeCounter value 0x%x\n",(unsigned int)timeCounter);
    return ( timeCounter );
}
...
static RtcCalendar_t RtcGetCalendar( void )
{
    ...
    //    printf("RtcGetCalendar: got date and time from HAL_RTC\n");
    calendar.CalendarCentury = Century;
